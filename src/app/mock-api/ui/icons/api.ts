...
import { feather, heroicons, material, custom_icons } from 'app/mock-api/ui/icons/data';
...
export class IconsMockApi {
  ...
  private readonly _custom_icons: any = custom_icons;
  ...
  registerHandlers(): void {
    ...
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService
      .onGet('api/ui/icons/custom-icons')
      .reply(() => [
        200,
        {
          namespace: 'custom-icons',
          name: 'Custom Icons',
          grid: 'icon-size-6',
          list: cloneDeep(this._custom_icons),
        },
      ]);
  }
}
