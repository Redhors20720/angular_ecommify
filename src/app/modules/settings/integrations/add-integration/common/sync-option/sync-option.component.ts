...
export abstract class SyncOptionComponent implements OnDestroy {
   ...
   */
  addChildren(event): void {
    event.stopPropagation();
    this.selectedField.isCollapsed = false;
  ...
  /**
   * Toggle mapping value options display
   *
   * @param valueOption
   */
  toggleValueOption(valueOption) : void {
    valueOption.isCollapsed = !valueOption.isCollapsed;
  }
}
